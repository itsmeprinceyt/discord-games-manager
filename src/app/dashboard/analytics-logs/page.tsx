...
export default function AnalyticsLogs() {
  ...
  const exportToCSV = (): void => {
    ...
    a.href = url;
    a.download = `crosstrade-analytics-${
        ...
        <div className="min-h-screen p-4 md:p-6">
          <div className="text-center py-12 bg-black/30 border border-stone-800 rounded-lg">
            ...
            <p className="text-stone-400 text-sm max-w-md mx-auto">
              Start adding cross-trades to see your analytics dashboard with
              monthly breakdowns and currency conversions.
            </p>
          </div>
        </div>
      </PageWrapper>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-3">
            ...
            {analytics.yearly_analytics.length > 0 && (
              <select
                ...
                className={`px-3 p-2 ${STONE_Button} text-stone-300 rounded-lg text-sm transition-colors cursor-pointer flex items-center gap-2`}
              >
        ...
        <div className="mt-6 p-4 bg-blue-900/10 border border-blue-800/30 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-stone-400">
              ...
              analytics data is based only on cross-trades recorded within this
              platform. Any deals conducted outside the platform or not entered
              into the system will not be reflected in these statistics. Please
              ensure all your trades are properly logged for accurate tracking.
            </p>
          </div>
        </div>
      </div>
